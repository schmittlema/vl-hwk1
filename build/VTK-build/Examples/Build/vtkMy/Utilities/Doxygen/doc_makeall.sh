...
# Example:
#   DOXYGEN_PROG=/usr/bin/doxygen        (INCLUDE(FindDoxygen.cmake))
#   GZIP_PROG=/bin/gzip              (INCLUDE(FindCygwin.cmake))
#   HHC_PROG= (INCLUDE(FindHTMLHelp.cmake))
#   MV_PROG=/bin/mv                  (INCLUDE(FindCygwin.cmake))
#   PERL_PROG=/usr/bin/perl              (INCLUDE(FindPerl.cmake))
#   RM_PROG=/bin/rm                  (INCLUDE(FindCygwin.cmake))
#   TAR_PROG=/bin/tar                (INCLUDE(FindCygwin.cmake))
#   WGET_PROG=/usr/bin/wget              (INCLUDE(FindWget.cmake))
#
export DOXYGEN_PROG="/usr/bin/doxygen"        # Doxygen
export GZIP_PROG="/bin/gzip"              # gzip (Unix-like 'gzip compressor')
export GNUPLOT_PROG="GNUPLOT_EXECUTABLE-NOTFOUND"        # gnuplot (data plotting program)
export HHC_PROG="" # HTML Help Compiler
export MV_PROG="/bin/mv"                  # mv (Unix-like 'move/rename files')
export PERL_PROG="/usr/bin/perl"              # Perl
export RM_PROG="/bin/rm"                  # rm (Unix-like 'remove files')
export TAR_PROG="/bin/tar"                # tar (Unix-like 'archiver')
export WGET_PROG="/usr/bin/wget"              # wget (remote file retrieval)
...
#
export PATH_TO_VTK_DOX_SCRIPTS="/home/schmittle/Documents/Vision_Learning/build/VTK/Utilities/Doxygen"

# SOURCE_DIR:
# Source directory. The top directory of the source files.
# Example:
#   SOURCE_DIR=/home/schmittle/Documents/Vision_Learning/build/VTK/Examples/Build/vtkMy
#
export SOURCE_DIR="/home/schmittle/Documents/Vision_Learning/build/VTK/Examples/Build/vtkMy"
...
# Example:
#   DOXTEMP=DOXTEMP=/home/schmittle/Documents/Vision_Learning/build/VTK-build/Examples/Build/vtkMy/Utilities/Doxygen
#   INTERMEDIATE_DOX_DIR=$DOXTEMP/dox
#
export DOXTEMP="/home/schmittle/Documents/Vision_Learning/build/VTK-build/Examples/Build/vtkMy/Utilities/Doxygen"
...
#
export CREATE_HTML_TARZ_ARCHIVE=OFF
...
#        or GENERATE_TAGFILE = "/Utilities/Doxygen/vtk4.tag")
# Example:
...
#
export DOWNLOAD_VTK_TAGFILE=ON
...
# ----------------------------------------------------------------------------
# Convert the VTKMY headers to the Doxygen format.
